  ...
  return (
    <nav className={clsx('bg-opacity-80 bg-white shadow fixed left-0 right-0 top-0 z-10')}>
      <div className="flex-1 max-w-7xl mx-auto flex h-16 justify-between items-center">
        ...
        <div className="flex items-center">
          <a
            href="https://github.com/apptension/openwind/issues/new?title=[element]%20Insert%20the%20title%20and%20leave%20the%20[element]%20tag%20at%20the%20beginning!&body=Remember%20to%20insert%20the%20description%20!%20%F0%9F%A4%93"
            target="_blank"
            rel="noreferrer"
            className="bg-transparent text-black hover:bg-gray-300 hover:text-gray-700 transition-colors inline-flex items-center px-2 py-1 rounded text-sm font-medium mr-2"
          >
            Request a component
          </a>
